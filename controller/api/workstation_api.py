...
async def get_workstation_projects(token_user:TokenUser=Depends(auth_token)) -> BaseRes:
    try:
        project_list:List[AtpProject]=Db.select_by_condition(AtpProject,[AtpProject.type==1,AtpProject.is_delete==2])
        parted_project_list=[]
        ...
        report_list:List[AtpProjectTestReport]=Db.select_by_condition(
            ...
            [AtpProjectTestReport.is_delete==2,AtpProjectTestReport.creator==token_user.user_id],
            None,
            None,
            10
        )
